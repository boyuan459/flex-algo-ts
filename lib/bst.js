...
var BST = /** @class */ (function () {
    ...
    BST.prototype._dfsKthSmallest = function (node, k, arr) {
    ...
    BST.prototype._lowestCommonAncestor = function (node, p, q) {
        if (node === null)
            return null;
        if (node.value === p || node.value === q)
            return node.value;
        var lp = this._lowestCommonAncestor(node.left, p, q);
        var rp = this._lowestCommonAncestor(node.right, p, q);
        if (lp && rp)
            return node.value;
        if (lp) {
            return lp;
    ...
    BST.prototype.lowestCommonAncestor = function (p, q) {
